...
export class TransferRecordsService {
  ...
  getAll(params?: {
    ...
    return this.apiService.get<ApiResponseModel<PaginatedTransferResponse>>('TransferRecords', params);
  }

  getById(id: string): Observable<ApiResponseModel<TransferRecordDetailDto>> {
    return this.apiService.get<ApiResponseModel<TransferRecordDetailDto>>(`TransferRecords/${id}`);
  }
  ...
  approve(id: string, data: ApproveTransferCommand): Observable<ApiResponseModel<any>> {
    return this.apiService.post<ApiResponseModel<any>>(`TransferRecords/${id}/approve`, data);
  }
}
