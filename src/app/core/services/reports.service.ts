...
export class ReportsService {
  ...
  getInventoryValuation(params?: {
    ...
    return this.apiService.get<ApiResponseModel<InventoryValuationReportDto>>('InventoryReports/valuation', params);
  }
  ...
  exportInventoryValuation(params?: {
    ...
    return this.apiService.get<Blob>('InventoryReports/valuation/export', params, { responseType: 'blob' });
  }
  ...
  getStockMovement(params?: {
    ...
    return this.apiService.get<ApiResponseModel<StockMovementReportDto>>('StockMovementReports', params);
  }
  ...
  exportStockMovement(params?: {
    ...
    return this.apiService.get<Blob>('StockMovementReports/export', params, { responseType: 'blob' });
  }
  ...
  getDisposalReport(params?: {
    ...
    return this.apiService.get<ApiResponseModel<DisposalReportDto>>('DisposalReports', params);
  }
  ...
  exportDisposalReport(params?: {
    ...
    return this.apiService.get<Blob>('DisposalReports/export', params, { responseType: 'blob' });
  }
  ...
  getRequisitionHistory(params?: {
    ...
    return this.apiService.get<ApiResponseModel<RequisitionHistoryReportDto>>('RequisitionReports', params);
  }
  ...
  exportRequisitionHistory(params?: {
    ...
    return this.apiService.get<Blob>('RequisitionReports/export', params, { responseType: 'blob' });
  }
  ...
  getPropertyValuation(params?: {
    ...
    return this.apiService.get<ApiResponseModel<PropertyValuationReportDto>>('PropertyReports/valuation', params);
  }
  ...
  exportPropertyValuation(params?: {
    ...
    return this.apiService.get<Blob>('PropertyReports/valuation/export', params, { responseType: 'blob' });
  }
  ...
  getPropertyIssuance(params?: {
    ...
    return this.apiService.get<ApiResponseModel<PropertyIssuanceReportDto>>('PropertyReports/issuance', params);
  }
}
