...
export class DashboardComponent {
  cards = [
    { title: 'Total Properties', value: '1,245', subtitle: 'apa' },
    { title: 'Total Locations', value: '64', subtitle: 'loc' },
    { title: 'Total Safety Boxes', value: '312', subtitle: 'inv€' },
    { title: 'Pending Requisitions', value: '18', subtitle: 'per' }
  ];
